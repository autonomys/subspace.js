...
import type { PoCOffenceDetails } from '@subspace/types/interfaces/offencesPoC';
import type { ConsensusLog, EquivocationProof, FarmerId, FarmerSignature, NextSaltDescriptor, NextSolutionRangeDescriptor, PoCBlockWeight, PoCEpochConfiguration, PoCEquivocationOffence, PoCGenesisConfiguration, PoCKind, PoCNextConfigDescriptor, PoCNextConfigDescriptorV1, PoCNextEpochDescriptor, PoCRandomness, ProposedProofOfSpaceResult, RawPoCPreDigest, RpcNewSlotInfo, RpcSolution, SaltDescriptor, Solution, SolutionRangeDescriptor } from '@subspace/types/interfaces/poC';
import type { AccountId, AccountId20, AccountId32, AccountIdOf, AccountIndex, Address, AssetId, Balance, BalanceOf, Block, BlockNumber, BlockNumberFor, BlockNumberOf, Call, CallHash, CallHashOf, ChangesTrieConfiguration, ChangesTrieSignal, CodecHash, Consensus, ConsensusEngineId, Digest, DigestItem, EncodedJustification, ExtrinsicsWeight, Fixed128, Fixed64, FixedI128, FixedI64, FixedU128, FixedU64, H1024, H128, H160, H2048, H256, H32, H512, H64, Hash, Header, HeaderPartial, I32F32, Index, IndicesLookupSource, Justification, Justifications, KeyTypeId, KeyValue, LockIdentifier, LookupSource, LookupTarget, ModuleId, Moment, MultiAddress, MultiSigner, OpaqueCall, Origin, OriginCaller, PalletId, PalletVersion, PalletsOrigin, Pays, PerU16, Perbill, Percent, Permill, Perquintill, Phantom, PhantomData, PoCBalance, PocMoment, PreRuntime, Releases, RuntimeDbWeight, Seal, SealV0, SignedBlock, SignedBlockWithJustification, SignedBlockWithJustifications, Slot, StorageData, StorageProof, TransactionInfo, TransactionPriority, TransactionStorageProof, U32F32, ValidatorId, ValidatorIdOf, Weight, WeightMultiplier } from '@subspace/types/interfaces/runtime';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    NextSaltDescriptor: NextSaltDescriptor;
    NextSolutionRangeDescriptor: NextSolutionRangeDescriptor;
    NodeRole: NodeRole;
    ...
    PoCBalance: PoCBalance;
    PoCBlockWeight: PoCBlockWeight;
    PoCEpochConfiguration: PoCEpochConfiguration;
    PoCEquivocationOffence: PoCEquivocationOffence;
    PoCGenesisConfiguration: PoCGenesisConfiguration;
    PoCKind: PoCKind;
    PocMoment: PocMoment;
    PoCNextConfigDescriptor: PoCNextConfigDescriptor;
    PoCNextConfigDescriptorV1: PoCNextConfigDescriptorV1;
    PoCNextEpochDescriptor: PoCNextEpochDescriptor;
    PoCOffenceDetails: PoCOffenceDetails;
    PoCRandomness: PoCRandomness;
    Points: Points;
    ...
    ProposedProofOfSpaceResult: ProposedProofOfSpaceResult;
    ...
    RawOrigin: RawOrigin;
    RawPoCPreDigest: RawPoCPreDigest;
    ...
    RpcNewSlotInfo: RpcNewSlotInfo;
    RpcSolution: RpcSolution;
    RuntimeDbWeight: RuntimeDbWeight;
    RuntimeDispatchInfo: RuntimeDispatchInfo;
    RuntimeVersion: RuntimeVersion;
    RuntimeVersionApi: RuntimeVersionApi;
    RuntimeVersionPartial: RuntimeVersionPartial;
    SaltDescriptor: SaltDescriptor;
    Schedule: Schedule;
    Scheduled: Scheduled;
    ...
    SolutionRangeDescriptor: SolutionRangeDescriptor;
