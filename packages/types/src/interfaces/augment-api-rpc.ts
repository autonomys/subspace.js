...
import type { ProposedProofOfSpaceResult, RpcNewSlotInfo } from '@subspace/types/interfaces/poC';
import type { AccountId, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, SignedBlock, StorageData } from '@subspace/types/interfaces/runtime';
...
declare module '@polkadot/rpc-core/types.jsonrpc' {
  export interface RpcInterface {
    ...
    poC: {
      /**
       * rpc method to propose a proof of space
       **/
      proposeProofOfSpace: AugmentedRpc<(proposed_proof_of_space_result: ProposedProofOfSpaceResult | { slot_number?: any; solution?: any; secret_key?: any } | string | Uint8Array) => Observable<Null>>;
      /**
       * Slot info subscription
       **/
      subscribeSlotInfo: AugmentedRpc<() => Observable<RpcNewSlotInfo>>;
    };
    rpc: {
      /**
